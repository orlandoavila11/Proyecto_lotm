...
export const CAMERA_PRESETS: Record<CameraPresetId, CameraPreset> = {
  ...
  FOCUS_DESK: { x: 0, y: -220, zoom: 1.35 },
  FOCUS_CORKBOARD: { x: -750, y: 140, zoom: 1.50 },
  FOCUS_HORNACINA: { x: 80, y: 260, zoom: 1.65 },
  FOCUS_STAIRCASE: { x: 720, y: -40, zoom: 1.45 }
};
...
export const CANONICAL_HOTSPOTS: Record<HotspotId, HotspotContract> = {
  hotspot_mirror: {
    ...
    bounds: { x: 580, y: 390, width: 240, height: 290 },
    depthLayer: 2,
  ...
  hotspot_chalice: {
    ...
    bounds: { x: 800, y: 220, width: 220, height: 300 },
    depthLayer: 1,
  ...
  hotspot_corkboard: {
    ...
    bounds: { x: 1460, y: 220, width: 420, height: 380 },
    depthLayer: 1,
  ...
  hotspot_candle: {
    ...
    bounds: { x: 420, y: 320, width: 160, height: 380 },
    depthLayer: 2,
    cameraPreset: 'FOCUS_DESK',
  ...
  hotspot_almanack: {
    ...
    bounds: { x: 1160, y: 390, width: 330, height: 250 },
    depthLayer: 2,
    cameraPreset: 'FOCUS_DESK',
  ...
  hotspot_identity_papers: {
    ...
    bounds: { x: 830, y: 660, width: 450, height: 190 },
    depthLayer: 2,
    cameraPreset: 'FOCUS_DESK',
  ...
  hotspot_acting_diary: {
    ...
    bounds: { x: 530, y: 690, width: 390, height: 220 },
    depthLayer: 2,
    cameraPreset: 'FOCUS_DESK',
  ...
  hotspot_money_pouch: {
    ...
    bounds: { x: 1470, y: 610, width: 210, height: 130 },
    depthLayer: 2,
    cameraPreset: 'FOCUS_DESK',
  ...
  hotspot_bazaar_letter: {
    ...
    bounds: { x: 1290, y: 720, width: 310, height: 110 },
    depthLayer: 2,
    cameraPreset: 'FOCUS_DESK',
  ...
  hotspot_staircase_door: {
    ...
    bounds: { x: 20, y: 80, width: 280, height: 720 },
    depthLayer: 1,
  ...
  hotspot_mahogany_cracks: {
    ...
    bounds: { x: 350, y: 860, width: 1200, height: 110 },
    depthLayer: 2,
    cameraPreset: 'FOCUS_DESK',
