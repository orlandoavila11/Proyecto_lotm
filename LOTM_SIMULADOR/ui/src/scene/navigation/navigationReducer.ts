...
const VALID_TRANSITIONS: Record<NavigationState, NavigationState[]> = {
  DESK_WIDE: ['DESK_FOCUS', 'INSPECTION_LAYER', 'CORKBOARD_STAGE', 'COMBAT_STAGE', 'CEREMONY_STAGE', 'CALENDAR_STAGE', 'MARKET_STAGE', 'ACTING_STAGE', 'IDENTITY_STAGE'],
  DESK_FOCUS: ['DESK_WIDE', 'INSPECTION_LAYER', 'CORKBOARD_STAGE', 'COMBAT_STAGE', 'CEREMONY_STAGE', 'CALENDAR_STAGE', 'MARKET_STAGE', 'ACTING_STAGE', 'IDENTITY_STAGE'],
  ...
  IDENTITY_STAGE: ['DESK_WIDE', 'DESK_FOCUS']
};
